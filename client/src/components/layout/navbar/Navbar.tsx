    ...
    <nav className={styles.navbar}>
        ...
        <div className={styles.inner}>
          ...
          <div className={styles.mobileToggle}>
            <button onClick={() => setIsMenuOpen(!isMenuOpen)} className={styles.toggleBtn}>
              {!isMenuOpen ? (
                <svg className={styles.icon} viewBox="0 0 24 24" stroke="currentColor" fill="none">
      ...
      <AnimatePresence>
        {isMenuOpen && (
          ...
          >
            <Link href="/shop" className={styles.mobileLink}>Shop Now</Link>
            <Link href="/featured" className={styles.mobileLink}>Featured Products</Link>
            <Link href="/about" className={styles.mobileLink}>About Us</Link>
            <Link href="/showroom" className={styles.mobileLink}>Virtual Showroom</Link>
